...
def _normalize_record(record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Generate study ID
    normalized["study_id"] = (
        f"RIS_{hash(str(normalized.get('title', '')) + str(normalized.get('year', ''))) % 10000:04d}"
    )
...
def export_ris(records: List[Dict[str, Any]], file_path: str, default_type: str = "JOUR") -> None:
    """
