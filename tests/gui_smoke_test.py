...
def test_meta_analysis_engine():
    ...
    print(
        f"  ✓ Binary OR meta-analysis: OR = {results['pooled']['effect']:.3f} "
...
def test_grade():
    ...
    from poolr.meta.grade import CertaintyLevel, GRADEAssessment
...
def test_ris():
    ...
    from poolr.import_.ris import export_ris, parse_ris_string, ris_to_screening_records
