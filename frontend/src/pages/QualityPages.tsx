...
export function RoB2Page({ }: Props) {
...
export function RobinsIPage({ }: Props) {
  const [studies, setStudies] = useState<any[]>([
...
export function Quadas2Page({ }: Props) {
  const [studies, setStudies] = useState<any[]>([
...
export function Amstar2Page({ }: Props) {
...
export function GradeEvidenceProfilePage({ }: Props) {
  const [studies, setStudies] = useState<any[]>([
