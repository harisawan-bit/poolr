    ...
    public static ConvertResponse Run(ConvertRequest req)
    {
        ...
        switch (req.conversion)
        {
            case "or2rr":
            {
                ...
                return new ConvertResponse { conversion = "or2rr", result = rr,
            ...
            case "rr2or":
            {
                ...
                return new ConvertResponse { conversion = "rr2or", result = orr,
            ...
            case "or2rd":
            {
                ...
                return new ConvertResponse { conversion = "or2rd", result = p1 - p0,
                    note = $"OR {req.value} -> RD at control rate p0={p0}" };
            }
            case "rd2nnt":
            {
                if (req.value == 0) throw new ArgumentException("RD must be non-zero");
                return new ConvertResponse { conversion = "rd2nnt", result = 1.0 / Math.Abs(req.value),
            ...
            case "smd2or":
            {
                ...
                return new ConvertResponse { conversion = "smd2or", result = Math.Exp(lnOr),
            ...
            case "or2smd":
            {
                ...
                return new ConvertResponse { conversion = "or2smd", result = d,
            ...
            case "median_to_mean_sd":
            {
                ...
                return new ConvertResponse { conversion = "median_to_mean_sd", result = mean,
                    extra = extra, note = "Wan et al. 2014 approximation" };
            }
            case "ci_to_se":
            {
                ...
                extra["se"] = se;
                return new ConvertResponse { conversion = "ci_to_se", result = se,
                    extra = extra, note = "SE from 95% CI width" };
            }
            default:
