...
/// <summary>
/// Phase 11 — Reporting engine (v0.6.0).
...
<footer>
<p>Generated by poolr v0.6.0 on {DateTime.Now:yyyy-MM-dd HH:mm}</p>
<p>This report accompanies a reproducible poolr project file.</p>
    ...
    {
        var sb = new StringBuilder();
        sb.AppendLine("# poolr v0.6.0 Python replication script");
    ...
    {
        var sb = new StringBuilder();
        sb.AppendLine("* poolr v0.6.0 Stata replication script");
        sb.AppendLine($"* Studies: {req.studies}, Participants: {req.participants}");
