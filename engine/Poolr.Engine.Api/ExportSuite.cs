...
public static class ExportSuite
{
    ...
    public static string RReplication(ExtendedMetaResponse r, List<Study> data)
    {
        ...
        sb.AppendLine("# poolr v0.5.3 replication script — run with library(metafor)");
    ...
    public static string MethodsParagraph(ExtendedMetaResponse r)
    {
        ...
        sb.Append("Analyses were conducted in poolr v0.5.3; an R/metafor replication script accompanies this report.");
        return sb.ToString();
    }
