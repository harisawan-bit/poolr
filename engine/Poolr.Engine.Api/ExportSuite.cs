...
/// <summary>
/// v0.6.0 export suite: R/metafor replication code, BibTeX/RIS citation export,
...
public static class ExportSuite
{
    ...
    public static string RReplication(ExtendedMetaResponse r, List<Study> data)
    {
        ...
        sb.AppendLine("# poolr v0.6.0 replication script — run with library(metafor)");
    ...
    public static string MethodsParagraph(ExtendedMetaResponse r)
    {
        ...
        sb.Append("Analyses were conducted in poolr v0.6.0; an R/metafor replication script accompanies this report.");
        return sb.ToString();
    }
