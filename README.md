...
> **Current release — v0.5.7.** Complete SRMA platform: Network MA (frequentist + Bayesian), Multilevel/Multivariate/RVE, Diagnostic Test Accuracy, IPD, Dose-Response, Proportions GLMM, Prediction Intervals, Survival extensions (RMST), Living Systematic Review, Reporting (LaTeX/HTML/Python/Stata), Collaboration, 67 engine tests. Plus all v0.5.3 features: light/dark themes, floating dock, command palette, boot splash, live computation states, screening funnel, dual-reviewer, PRISMA flow. v0.5.1: Knapp-Hartung CIs, Mantel-Haenszel & Peto poolers, trim-and-fill, PET/PEESE/p-curve, proportions/rates/correlations, robvis-style RoB, GRADE SoF, R replication scripts, PRISMA 27-item checklist. v0.5.2: no console-window flash, truthful version/connection indicators. **100% Python-free** (Tauri 2 / Rust, React + TypeScript, C# 12 / .NET 8). 12 SRMA pages, 6-OS installers. See [RELEASES.md](./RELEASES.md) for details.
